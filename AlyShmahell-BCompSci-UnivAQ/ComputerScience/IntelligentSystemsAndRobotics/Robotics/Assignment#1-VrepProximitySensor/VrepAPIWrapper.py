...
def senseFunction():
	# connect to sensor
	errorCode,sensorHandle=vrep.simxGetObjectHandle(clientID,'Proximity_sensor',vrep.simx_opmode_streaming)
	# read sensor data
	returnCode, detectionState, detectedPoint, detectedObjectHandle, detectedSurfaceNormalVector=vrep.simxReadProximitySensor(clientID, sensorHandle, vrep.simx_opmode_streaming)
	return detectionState, detectedPoint, detectedObjectHandle
