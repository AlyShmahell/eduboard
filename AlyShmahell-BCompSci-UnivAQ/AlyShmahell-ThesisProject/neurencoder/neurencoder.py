...
class asymmetric_model_tester(base):
	...
	def iterate_pub_key_generation(self, key_seed_val):
		iteration_progressbar = progress_bar(
...
class asymmetric_model_engine(
        result_processor, asymmetric_hyper_parameters, helper_functions,
        model_data, asymmetric_training_model, asymmetric_testing_model,
        model_trainer, model_builder, asymmetric_model_tester,
        general_model_engine, general_hyper_parameters):
...
class symmetric_model_engine(
        result_processor, symmetric_hyper_parameters, helper_functions,
...
class hybrid_model_engine(result_processor, asymmetric_hyper_parameters,
                          helper_functions, model_data, hybrid_training_model,
                          hybrid_testing_model, model_trainer, model_builder,
                          symmetric_model_tester, general_model_engine,
                          general_hyper_parameters):
